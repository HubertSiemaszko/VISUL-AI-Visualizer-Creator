...
const Timeline = () => {
        ...
        fetch('http://127.0.0.1:8000/clips')
            ...
            .then(data => {
                if (data.clips && data.clips.length > 0) {
                    ...
                    const clipsWithOffset = data.clips.map((c: any) => ({
                        ...c,
                        sourceOffset: c.sourceOffset || 0
                    }));
                    setClips(clipsWithOffset);
                }
            })
    ...
    useEffect(() => {
        ...
        if (activeVideoClip) {
            const clipLocalTime = (currentTime - activeVideoClip.start) + (activeVideoClip.sourceOffset || 0);
    ...
    useEffect(() => {
        ...
        if (activeAudioClip && activeAudioClip.audioUrl) {
            ...
            const clipLocalTime = (currentTime - activeAudioClip.start) + (activeAudioClip.sourceOffset || 0);
        ...
        if (splitMode) {
            ...
            if (splitTime > 0 && splitTime < clip.duration) {
                ...
                const rightClip: ClipType = {
                    ...
                    sourceOffset: (clip.sourceOffset || 0) + splitTime
                };
                ...
                if (clip.linkedAudioId) {
                    ...
                    if (linkedAudio) {
                        const leftAudio: ClipType = {
                            ...linkedAudio,
                            id: `${linkedAudio.id}_L_${uid}`,
                            duration: splitTime,
                            linkedVideoId: leftClip.id
                        };
                        const rightAudio: ClipType = {
                            ...linkedAudio,
                            id: `${linkedAudio.id}_R_${uid}`,
                            start: linkedAudio.start + splitTime,
                            duration: linkedAudio.duration - splitTime,
                            sourceOffset: (linkedAudio.sourceOffset || 0) + splitTime,
                            linkedVideoId: rightClip.id
                        };

                        leftClip.linkedAudioId = leftAudio.id;
                        rightClip.linkedAudioId = rightAudio.id;
                ...
                if (clip.linkedVideoId) {
                    ...
                    if (linkedVideo) {
                        const leftVideo: ClipType = {
                            ...linkedVideo,
                            id: `${linkedVideo.id}_L_${uid}`,
                            duration: splitTime,
                            linkedAudioId: leftClip.id
                        };
                        const rightVideo: ClipType = {
                            ...linkedVideo,
                            id: `${linkedVideo.id}_R_${uid}`,
                            start: linkedVideo.start + splitTime,
                            duration: linkedVideo.duration - splitTime,
                            sourceOffset: (linkedVideo.sourceOffset || 0) + splitTime,
                            linkedAudioId: rightClip.id
                        };

                        leftClip.linkedVideoId = leftVideo.id;
                        rightClip.linkedVideoId = rightVideo.id;
